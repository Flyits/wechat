...
namespace app\baicao\controller\v1\pay;
...
class Bank
{
    public static function get($key)
    {
        $bankList = [
            "ICBC_DEBIT"        => "工商银行(借记卡)",
            "ICBC_baicao"       => "工商银行(信用卡)",
            "ABC_DEBIT"         => "农业银行(借记卡)",
            "ABC_baicao"        => "农业银行(信用卡)",
            "PSBC_DEBIT"        => "邮政储蓄银行(借记卡)",
            "PSBC_baicao"       => "邮政储蓄银行(信用卡)",
            "CCB_DEBIT"         => "建设银行(借记卡)",
            "CCB_baicao"        => "建设银行(信用卡)",
            "CMB_DEBIT"         => "招商银行(借记卡)",
            "CMB_baicao"        => "招商银行(信用卡)",
            ...
            "BOC_baicao"        => "中国银行(信用卡)",
            "COMM_DEBIT"        => "交通银行(借记卡)",
            "COMM_baicao"       => "交通银行(信用卡)",
            "SPDB_DEBIT"        => "浦发银行(借记卡)",
            "SPDB_baicao"       => "浦发银行(信用卡)",
            "GDB_DEBIT"         => "广发银行(借记卡)",
            "GDB_baicao"        => "广发银行(信用卡)",
            "CMBC_DEBIT"        => "民生银行(借记卡)",
            "CMBC_baicao"       => "民生银行(信用卡)",
            "PAB_DEBIT"         => "平安银行(借记卡)",
            "PAB_baicao"        => "平安银行(信用卡)",
            "CEB_DEBIT"         => "光大银行(借记卡)",
            "CEB_baicao"        => "光大银行(信用卡)",
            ...
            "CITIC_baicao"      => "中信银行(信用卡)",
            "BOSH_DEBIT"        => "上海银行(借记卡)",
            "BOSH_baicao"       => "上海银行(信用卡)",
            "CRB_DEBIT"         => "华润银行(借记卡)",
            "HZB_DEBIT"         => "杭州银行(借记卡)",
            "HZB_baicao"        => "杭州银行(信用卡)",
            "BSB_DEBIT"         => "包商银行(借记卡)",
            ...
            "SZRCB_baicao"      => "深圳农商银行(信用卡)",
            "HRBB_DEBIT"        => "哈尔滨银行(借记卡)",
            "BOCD_DEBIT"        => "成都银行(借记卡)",
            "GDNYB_DEBIT"       => "南粤银行(借记卡)",
            "GDNYB_baicao"      => "南粤银行(信用卡)",
            "GZCB_DEBIT"        => "广州银行(借记卡)",
            "GZCB_baicao"       => "广州银行(信用卡)",
            "JSB_DEBIT"         => "江苏银行(借记卡)",
            "JSB_baicao"        => "江苏银行(信用卡)",
            "NBCB_DEBIT"        => "宁波银行(借记卡)",
            "NBCB_baicao"       => "宁波银行(信用卡)",
            "NJCB_DEBIT"        => "南京银行(借记卡)",
            "QHNX_DEBIT"        => "青海农信(借记卡)",
            "ORDOSB_baicao"     => "鄂尔多斯银行(信用卡)",
            "ORDOSB_DEBIT"      => "鄂尔多斯银行(借记卡)",
            "BJRCB_baicao"      => "北京农商(信用卡)",
            "BHB_DEBIT"         => "河北银行(借记卡)",
            "BGZB_DEBIT"        => "贵州银行(借记卡)",
            "BEEB_DEBIT"        => "鄞州银行(借记卡)",
            "PZHCCB_DEBIT"      => "攀枝花银行(借记卡)",
            "QDCCB_baicao"      => "青岛银行(信用卡)",
            ...
            "WFB_baicao"        => "潍坊银行(信用卡)",
            "WFB_DEBIT"         => "潍坊银行(借记卡)",
            "WHB_baicao"        => "威海商业银行(信用卡)",
            "WHB_DEBIT"         => "威海市商业银行(借记卡)",
            "WHRC_baicao"       => "武汉农商(信用卡)",
            ...
            "AE_baicao"         => "AE(信用卡)",
            "TACCB_baicao"      => "泰安银行(信用卡)",
            "TACCB_DEBIT"       => "泰安银行(借记卡)",
            "TCRCB_DEBIT"       => "太仓农商行(借记卡)",
            "TJBHB_baicao"      => "天津滨海农商行(信用卡)",
            ...
            "CZB_baicao"        => "浙商银行(信用卡)",
            "CZB_DEBIT"         => "浙商银行(借记卡)",
            "CZCB_baicao"       => "稠州银行(信用卡)",
            "CZCB_DEBIT"        => "稠州银行(借记卡)",
            "DANDONGB_baicao"   => "丹东银行(信用卡)",
            "DANDONGB_DEBIT"    => "丹东银行(借记卡)",
            "DLB_baicao"        => "大连银行(信用卡)",
            "DLB_DEBIT"         => "大连银行(借记卡)",
            "DRCB_baicao"       => "东莞农商银行(信用卡)",
            "DRCB_DEBIT"        => "东莞农商银行(借记卡)",
            "CSRCB_baicao"      => "常熟农商银行(信用卡)",
            "DYB_DEBIT"         => "东营银行(借记卡)",
            "DYCCB_DEBIT"       => "德阳银行(借记卡)",
            "FBB_DEBIT"         => "富邦华一银行(借记卡)",
            "FDB_DEBIT"         => "富滇银行(借记卡)",
            "FJHXB_baicao"      => "福建海峡银行(信用卡)",
            ...
            "GLB_DEBIT"         => "桂林银行(借记卡)",
            "GRCB_baicao"       => "广州农商银行(信用卡)",
            "GRCB_DEBIT"        => "广州农商银行(借记卡)",
            "GSB_DEBIT"         => "甘肃银行(借记卡)",
            "GSNX_DEBIT"        => "甘肃农信(借记卡)",
            "GXNX_DEBIT"        => "广西农信(借记卡)",
            "GYCB_baicao"       => "贵阳银行(信用卡)",
            "GYCB_DEBIT"        => "贵阳银行(借记卡)",
            "GZNX_DEBIT"        => "贵州农信(借记卡)",
            "HAINNX_baicao"     => "海南农信(信用卡)",
            "HKB_DEBIT"         => "汉口银行(借记卡)",
            "HANAB_DEBIT"       => "韩亚银行(借记卡)",
            "HBCB_baicao"       => "湖北银行(信用卡)",
            "HBCB_DEBIT"        => "湖北银行(借记卡)",
            "HBNX_baicao"       => "湖北农信(信用卡)",
            "HBNX_DEBIT"        => "湖北农信(借记卡)",
            "HDCB_DEBIT"        => "邯郸银行(借记卡)",
            ...
            "JCB_baicao"        => "JCB(信用卡)",
            "MASTERCARD_baicao" => "MASTERCARD(信用卡)",
            "VISA_baicao"       => "VISA(信用卡)",
            "LQT"               => "零钱通"
        ];
        return $bankList[$key];
    }
